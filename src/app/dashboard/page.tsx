  ...
  return (
    <>
      <div className="w-full p-3">
        <div className="w-full justify-start items-center gap-4 inline-flex mb-[38px]">
          <Image
            src={`/brick.png`}
            alt="user-image"
            height={71}
        ...
        <div className="w-full gap-3 flex">
          ...
          <div className="w-1/3 p-6 bg-white rounded-[10px] justify-start items-center gap-2.5 flex flex-col">
            <div className="flex-col justify-start items-start gap-6 inline-flex w-full mb-6">
              {/* top with texts */}
              ...
              <div className="justify-start items-center gap-2 inline-flex">
                <div className="justify-start items-center gap-2 flex">
                  <button className="p-[17px] bg-[#2069a0] rounded-[5px] justify-start items-center gap-2.5 flex text-right text-white text-sm font-normal font-['Noto Sans']">
                    Mint New Tokens
                  </button>
                </div>
              </div>
