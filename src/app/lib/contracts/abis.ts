...
export const iMarketAbi = [
  ...
  { type: 'error', inputs: [], name: 'MismatchData' },
  { type: 'error', inputs: [], name: 'NotBought' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'nft_token', internalType: 'address', type: 'address' },
...
export const iSeabrickAbi = [
  ...
  { type: 'error', inputs: [], name: 'NotBurned' },
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: '_interface', internalType: 'uint8[4]', type: 'uint8[4]' },
    ],
