    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <form onSubmit={handleConfirm} className='flex flex-col gap-y-4 w-full'>
        <div className="flex flex-col items-start gap-y-4 w-[40rem]">
          ...
          <p className="text-gray-800 text-start">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-y-4 w-full'>
        <div className="flex flex-col items-start gap-y-4 w-[40rem]">
          ...
          <p className="text-[#8A8A8F] text-sm">Are you sure you want to transfer your app ownership to <b>{email}</b></p>
        </div>
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <div className="flex flex-col gap-y-4 w-[40rem]">
        ...
        <p className="text-[#8A8A8F] text-sm">Your app ownership was succesfuly transferred to <b>{email}</b></p>
        <div className="flex justify-end gap-4 w-full mt-4">
          <button
            onClick={onClose}
            className="text-white text-sm p-[17px] bg-text-gray hover:bg-text-gray/90 rounded-[5px]"
...
const App: React.FC = () => {
  ...
  return (
    <div className=''>
      <button className="p-2 bg-[#333333] hover:bg-[#555555] active:bg-[#222222] text-[white] rounded-[5px] text-left w-full" onClick={() => setShowEmailModal(true)}>
