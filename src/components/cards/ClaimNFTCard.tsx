...
export default function ClaimNFTCard() {
  ...
  return (
    <>
      ...
      <div className="h-full w-full p-3 bg-gradient-to-b from-[#52b09f] to-[#005391] rounded-[10px] flex-col justify-between items-start inline-flex">
        <div className="h-[] flex-col justify-start items-start gap-2 flex">
